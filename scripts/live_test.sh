...
start_b2k() {
    ...
    ../../../src/dsc/bin/Debug/net9.0/$OS/dsc connect --service stats-api --namespace todo-app --local-port 3001 --control-port 51424 --use-kubernetes-service-environment-variables -- npm run start & b2kPID=$!
    sleep 30
